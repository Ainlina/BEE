function [ p, t, stat ] = distmesh( fd, fh, h0, bbox, p_fix, convmult, e_fix, it_max, fid, fit )
% DISTMESH 2D/3D Mesh generation using distance functions.
% Original code: Per-Olof Persson and Gilbert Strang, "A Simple Mesh Generator in MATLAB," SIAM Review Vol. 46 (2) 2004.
% Available online at http://persson.berkeley.edu/distmesh/index.html
% Copyright 2004-2012 Per-Olof Persson, released under GNU GPL v2 or later
% I have opted to use it in accordance with v3.
% Modified by Christopher McGarry to include “convmult” argument
% The resulting modified code is released under the GNU General Public License version 3
% Modifications are for project due Monday 18 March 2019
%
%   [ P, T, STAT ] = DISTMESH( FD, FH, H0, BBOX, P_FIX, CONVMULT, E_FIX, IT_MAX, FID, FIT )
%
...
%      CONVMULT	   Multiplier that determines dpc_tol, which is h0*convmult; previously this was fixed at 0.001
...
dpc_tol = convmult*h0;       % Abs tol for grid point movements during convergence check.
